import {
  ...
  FirePK16,
  FirePK16_2,
  FirePK16_3, FirePK16_4, FirePK16_5, FirePK16_6,
  Radar,
} from './missile.js';
...
export class Fregata extends Ship {
  constructor(simulare) {
    ...
    this.firePK16_3 = new FirePK16_3(
      this.simulare,
      this.x + this.width / 1,
      this.y + this.height / 3.2
    );
    this.firePK16_4 = new FirePK16_4(
      this.simulare,
      this.x + this.width / 1.2,
      this.y + this.height / 3.2
    );
    this.firePK16_5 = new FirePK16_5(
      this.simulare,
      this.x + this.width / 1.4,
      this.y + this.height / 3.2
    );
    this.firePK16_6 = new FirePK16_6(
      this.simulare,

...
export class Simulare {
  ...
  scenariu1(context) {
    if (this.scenariu1Time && this.continue) {
      ...
      this.ships[2].firePK16_3.update(context);
      this.ships[2].firePK16_4.update(context);
      this.ships[2].firePK16_5.update(context);
      this.ships[2].firePK16_6.update(context);
